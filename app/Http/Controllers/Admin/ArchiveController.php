        ...
        if ($booking->status === Booking::STATUS_APPROVED) {
            VenueEvent::firstOrCreate(
                ...
                [
                    ...
                    'start_time' => $booking->event_date->toDateString() . ' ' . Carbon::parse($booking->start_time)->format('H:i:s'),
                    'end_time'   => $booking->event_date->toDateString() . ' ' . Carbon::parse($booking->end_time)->format('H:i:s'),
                    'created_by' => auth()->id(),
                ]
            );
        }
