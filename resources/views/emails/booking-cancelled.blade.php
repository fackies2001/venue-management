...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>We regret to inform you that your venue booking has been <strong>cancelled</strong> by the administrator.
            </p>
            ...
            @if ($booking->admin_remarks)
                <div class="detail-row">
                    <div class="detail-label">Reason for Cancellation</div>
                    <div>{{ $booking->admin_remarks }}</div>
                </div>
            @endif

            <p style="margin-top:24px;">We apologize for the inconvenience. Please feel free to re-book on another
                available date or contact the admin for further assistance.</p>
        </div>
        <div class="footer">
