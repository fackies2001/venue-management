...
<head>
    ...
    <style>
        ...
        .btn-login {
            ...
            border: none;
            color: #fff;
            /* Pinalitan to white para consistent sa register */
            font-weight: 600;
            width: 100%;
            padding: .65rem;
            border-radius: 8px;
        ...
        .divider {
            text-align: center;
            color: #888;
            /* Ginawang neutral color para mas malinis tingnan */
            font-size: .8rem;
        ...
        /* Eye toggle sa loob ng input group */
        .toggle-eye-btn {
...
<body>
    ...
    <script>
        // Function para sa Eye Toggle ng Password
        function toggleEye() {
